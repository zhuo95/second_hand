...
//设置expire时间
    ...
    public static void main(String[] args) {
        ...
        RedisPoolUtil.set("foggy","studio");

        String value = RedisPoolUtil.get("foggy");

        RedisPoolUtil.setEx("keye",60*10,"valuee");

        RedisPoolUtil.expire("foggy",60*20);

        RedisPoolUtil.del("keye");
    }
